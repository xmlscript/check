...
class 身份证{
  ...
  function __construct(string $id){
    ...
    $a = str_pad(substr($id,0,3),6,0,STR_PAD_RIGHT);
    $b = str_pad(substr($id,0,4),6,0,STR_PAD_RIGHT);
    $c = substr($id,0,6);
    $this->地址 = static::AREA[$a].static::AREA[$b].static::AREA[$c];
