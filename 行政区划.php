...
class 行政区划{
  ...
  private const latest = '2019-12';//18d22d8d9a46b75f7f0e3fcfb2b5538a
  ...
  final static function 代码(int $q, \DateTimeInterface $pubdate=null){
    ...
    default:
      if(isset(static::C[$aabb00]))
        return static::A[$aa0000].static::B[$aa0000][$aabb00].static::C[$aabb00][$q];
      elseif(isset(static::C[$aa0000]))
        return static::A[$aa0000].static::C[$aa0000][$q];
    }
